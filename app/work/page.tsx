...
export const metadata: Metadata = {
  title: "Our Work",
  description:
    "Selected projects by Chillispark: Ekosight agritech, NovaKeebs keyboard store, Draftly document tool, Strydr sneaker store and Ittra perfumery, built to load fast and convert.",
};
