...
export const EMAIL = "hello@chillispark.in";
...
export const testimonials = [
  {
    photo: "/testimonials/avatar-20.png",
    name: "Dr. Arjun Mehta",
    role: "Bright Smile Dental · Delhi",
    quote:
      "Our new site brought in booking requests within the first week. Patients say it finally looks as professional as the clinic itself.",
  },
  {
    photo: "/testimonials/avatar-17.png",
    name: "Rohan Mehta",
    role: "Spice Route Kitchen",
    quote:
      "The old site was slow and impossible to update. ChilliSpark rebuilt it mobile-first and our reservations doubled in a month.",
  },
  {
    photo: "/testimonials/avatar-22.png",
    name: "Adv. Rajesh Verma",
    role: "Verma & Associates",
    quote:
      "Clients now find us on Google and reach out directly. The website builds trust before the very first call.",
  },
  {
    photo: "/testimonials/avatar-18.png",
    name: "Karan Singhania",
    role: "Luxe Beauty Bar",
    quote:
      "Beautiful, fast, and genuinely easy to manage. Online bookings come in even while the salon is closed.",
  },
  {
    photo: "/testimonials/avatar-21.png",
    name: "Aditya Sharma",
    role: "CorePulse Gym",
    quote:
      "Clean design, quick delivery, and real results. Membership signups from the site went up noticeably.",
  },
  {
    photo: "/testimonials/avatar-25.png",
    name: "Vikram Nair",
    role: "Metro Homes Realty",
    quote:
      "They understood our business, not just the tech. Our leads are higher volume and much better quality now.",
  },
  {
    photo: "/testimonials/avatar-19.png",
    name: "Suresh Iyer",
    role: "Iyer & Co. Consultants",
    quote:
      "Professional from day one. Clear timelines, honest pricing, and a website that finally matches the quality of our practice.",
  },
  {
    photo: "/testimonials/avatar-23.png",
    name: "Dev Rathore",
    role: "Rathore Interiors",
    quote:
      "Our portfolio finally looks premium on every phone. Inquiries started coming in from the site within days of launch.",
  },
  {
    photo: "/testimonials/avatar-24.png",
    name: "Tenzing Bhutia",
    role: "Mountain Brew Café",
    quote:
      "Simple, fast, and easy for customers to find us. Google searches now bring people straight to our counter.",
  },
];
